 ...
 */
public final class IntAvgFunctor extends AvgFunctor {
	
	private long sum = 0;
	private long count = 0;
	
	public IntAvgFunctor(int inputIndex, int outputIndex) {
	...
	public AbstractFunctor cloneMe() {
		return new IntAvgFunctor(getInputIndex(), getOutputIndex());
	}
}
