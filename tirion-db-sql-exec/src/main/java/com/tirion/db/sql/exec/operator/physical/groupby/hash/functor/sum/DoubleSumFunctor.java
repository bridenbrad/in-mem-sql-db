 ...
 */
public final class DoubleSumFunctor extends SumFunctor {

	private double sum = 0;
	
	public DoubleSumFunctor(int inputIndex, int outputIndex) {
	...
	public Functor cloneMe() {
		return new DoubleSumFunctor(getInputIndex(), getOutputIndex());
	}
}
