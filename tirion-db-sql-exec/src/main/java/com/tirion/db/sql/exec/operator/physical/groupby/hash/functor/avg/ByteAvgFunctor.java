 ...
 */
public final class ByteAvgFunctor extends AvgFunctor {

	private long sum = 0;
	private long count = 0;
	
	public ByteAvgFunctor(int inputIndex, int outputIndex) {
	...
	protected void onTupleInternal(Tuple tuple) {
		sum += tuple.getByte(getInputIndex());
		++count;
	}
	...
	public AbstractFunctor cloneMe() {
		return new ByteAvgFunctor(getInputIndex(), getOutputIndex());
	}
}
