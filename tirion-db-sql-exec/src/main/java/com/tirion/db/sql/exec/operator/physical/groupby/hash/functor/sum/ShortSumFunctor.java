 ...
 */
public final class ShortSumFunctor extends SumFunctor {
	
	private long sum = 0;
	
	public ShortSumFunctor(int inputIndex, int outputIndex) {
	...
	public Functor cloneMe() {
		return new ShortSumFunctor(getInputIndex(), getOutputIndex());
	}
}
