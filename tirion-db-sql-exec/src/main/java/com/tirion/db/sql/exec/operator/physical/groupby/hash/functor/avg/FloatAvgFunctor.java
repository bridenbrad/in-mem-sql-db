 ...
 */
public final class FloatAvgFunctor extends AvgFunctor {

	private double sum = 0;
	private long count = 0;

	public FloatAvgFunctor(int inputIndex, int outputIndex) {
	...
	public AbstractFunctor cloneMe() {
		return new FloatAvgFunctor(getInputIndex(), getOutputIndex());
	}
}
