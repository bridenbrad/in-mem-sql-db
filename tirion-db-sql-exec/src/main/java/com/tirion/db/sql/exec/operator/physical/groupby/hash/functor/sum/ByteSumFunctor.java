 ...
 */
public final class ByteSumFunctor extends SumFunctor {

	private long sum = 0;
	
	public ByteSumFunctor(int inputIndex, int outputIndex) {
	...
	public Functor cloneMe() {
		return new ByteSumFunctor(getInputIndex(), getOutputIndex());
	}
}
