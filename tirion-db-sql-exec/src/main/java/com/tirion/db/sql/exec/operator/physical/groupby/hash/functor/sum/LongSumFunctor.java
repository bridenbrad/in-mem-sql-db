 ...
 */
public final class LongSumFunctor extends SumFunctor {

	private long sum = 0;
	
	public LongSumFunctor(int inputIndex, int outputIndex) {
	...
	public Functor cloneMe() {
		return new LongSumFunctor(getInputIndex(), getOutputIndex());
	}
}
