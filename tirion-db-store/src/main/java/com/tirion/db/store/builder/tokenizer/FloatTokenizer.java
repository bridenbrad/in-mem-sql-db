 ...
 */
public abstract class FloatTokenizer implements Tokenizer {

	public static final class FloatToByteTokenizer extends FloatTokenizer {
		
		private final TokenMap<Byte, Float> tokenMap;

		public FloatToByteTokenizer(TokenMap<Byte, Float> tokenMap) {
			super();
		...
		public Array tokenize(Array array) {
			...
			float[] dataArray = (float[]) array.getUnderlying();
		...
		public Array detokenize(Array tokenArray) {
			...
			return new NativeArray(new Spec(Type.FLOAT, data.length, false, nullBitmap), data);
		}
		...
		public Array detokenize(Buffer buffer) {
			...
			float[] data = new float[buffer.getCount()];
	...
	public static final class FloatToShortTokenizer extends FloatTokenizer {
		
		private final TokenMap<Short, Float> tokenMap;

		public FloatToShortTokenizer(TokenMap<Short, Float> tokenMap) {
			super();
			this.tokenMap = tokenMap;
		}
