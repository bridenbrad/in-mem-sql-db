 ...
 */
public abstract class IntegerTokenizer implements Tokenizer {

	public static final class IntegerToByteTokenizer extends IntegerTokenizer {
		
		private final TokenMap<Byte, Integer> tokenMap;

		public IntegerToByteTokenizer(TokenMap<Byte, Integer> tokenMap) {
			super();
		...
		public Array tokenize(Array array) {
			...
			int[] dataArray = (int[]) array.getUnderlying();
		...
		public Array detokenize(Array tokenArray) {
			...
			return new NativeArray(new Spec(Type.INT, data.length, false, nullBitmap), data);
		}
		...
		public Array detokenize(Buffer buffer) {
			...
			int[] data = new int[buffer.getCount()];
	...
	public static final class IntegerToShortTokenizer extends IntegerTokenizer {
		
		private final TokenMap<Short, Integer> tokenMap;

		public IntegerToShortTokenizer(TokenMap<Short, Integer> tokenMap) {
			super();
			this.tokenMap = tokenMap;
		}
