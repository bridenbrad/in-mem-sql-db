 ...
 */
public abstract class ShortTokenizer implements Tokenizer {

	public static final class ShortToByteTokenizer extends ShortTokenizer {
		
		private final TokenMap<Byte, Short> tokenMap;

		public ShortToByteTokenizer(TokenMap<Byte, Short> tokenMap) {
			super();
		...
		public Array tokenize(Array array) {
			...
			short[] dataArray = (short[]) array.getUnderlying();
		...
		public Array detokenize(Array tokenArray) {
			...
			return new NativeArray(new Spec(Type.SHORT, data.length, false, nullBitmap), data);
		}
		...
		public Array detokenize(Buffer buffer) {
			...
			short[] data = new short[buffer.getCount()];
